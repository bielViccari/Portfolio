                    ...
                    <div className="projects">
                        <div className="project">
                            ...
                            <div className="disc">
                                ...
                                <a target='_blank' href="https://github.com/bielViccari/achadosZZZ">Veja o código do projeto</a>
                            </div>
                        </div>
                        <div className="project">
                            ...
                            <div className="disc">
                                ...
                                <a target='_blank' href="https://github.com/bielViccari/tcc">Veja o código do projeto</a>
                            </div>
                        </div>
                        <div className="project">
